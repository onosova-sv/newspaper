...
from .views import NewsList, One_news, NewsCreate, NewsUpdate, NewsDelete, ArticleCreate, ArticleDelete, ArticleUpdate
...
urlpatterns = [
   ...
   path('<int:pk>', cache_page(60*5)(One_news.as_view()), name='news_detail'),
